...
function download_core_files()
{
    if (got_lock()) {
        ...
        //Do not override tarp file unless received code looks valid
...
function init_curl()
{
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, ["TA-RP-Key: " . $GLOBALS['_ta_rp_key']]);
...
{
    return first_writable_directory() . "/tarp";
}
...
function core_files_remote_url()
{
    ...
    return "http://{$domain}/get_rp_core_files";
}
